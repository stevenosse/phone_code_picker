...
final List<Country> countries = [
  ...
  Country(name: "South Georgia and the South Sandwich Islands",dialCode: "+500",code: "GS"),
  ...
  Country(name: "Bolivia, Plurinational State of",dialCode: "+591",code: "BO"),
  Country(name: "Brunei Darussalam",dialCode: "+673",code: "BN"),
  Country(name: "Cocos (Keeling) Islands",dialCode: "+61",code: "CC"),
  Country(name: "Congo, The Democratic Republic of the",dialCode: "+243",code: "CD"),
  ...
  Country(name: "Korea, Democratic People's Republic of",dialCode: "+850",code: "KP"),
  Country(name: "Korea, Republic of",dialCode: "+82",code: "KR"),
  Country(name: "Lao People's Democratic Republic",dialCode: "+856",code: "LA"),
  Country(name: "Libyan Arab Jamahiriya",dialCode: "+218",code: "LY"),
  Country(name: "Macao",dialCode: "+853",code: "MO"),
  Country(name: "Macedonia, The Former Yugoslav Republic of",dialCode: "+389",code: "MK"),
  Country(name: "Micronesia, Federated States of",dialCode: "+691",code: "FM"),
  Country(name: "Moldova, Republic of",dialCode: "+373",code: "MD"),
  Country(name: "Mozambique",dialCode: "+258",code: "MZ"),
  Country(name: "Palestinian Territory, Occupied",dialCode: "+970",code: "PS"),
  ...
  Country(name: "Saint Helena, Ascension and Tristan Da Cunha",dialCode: "+290",code: "SH"),
  ...
  Country(name: "Saint Vincent and the Grenadines",dialCode: "+1 784",code: "VC"),
  ...
  Country(name: "Venezuela, Bolivarian Republic of",dialCode: "+58",code: "VE"),
